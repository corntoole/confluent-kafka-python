...
value = {"id": str(uuid4()), "query": query_string, "metadata": {"timestamp": str(int(time.time())),"tenant_id": "ACME_CORP"}, "querytype": "TYPED", "queryParams": {"query": query_string, "tenant": "ACME_CORP", "start": "2017-10-23T00:00:00.000Z", "end": end_ts, "sortby": "CPU", "sortorder": "ASC"}}
